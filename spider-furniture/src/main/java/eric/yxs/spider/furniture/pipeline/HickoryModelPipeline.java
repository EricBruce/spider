...
import eric.yxs.spider.furniture.common.model.HickorychairModel;
 ...
 */
@Slf4j
public class HickoryModelPipeline implements PageModelPipeline<HickorychairModel> {
    public void process(HickorychairModel detailModel, Task task) {
        String baseDir = "/data/spider/furniture/hickoryChair/" + detailModel.getDirName() + "/";
